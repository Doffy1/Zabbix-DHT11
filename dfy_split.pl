#!/usr/bin/perl
# Doffy, 2019.08.25
# Run $ARGV[0] command, split output by $ARGV[1] character and send to Zabbix first part of lines as keys
#       second part of lines as value
#
# Input parameters:
# $ARGV[0]: the command to run ( like: "apcaccess status 127.0.0.1:3551" )
# $ARGV[1]: the splitter character/string ( like: ":" or ": ")
# $ARGV[2]: the zabbix_sender parameters to use without "-k" and "-o" ( like: "-z zabbix.mydomain.hu" )
